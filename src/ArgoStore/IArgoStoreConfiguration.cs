...
public interface IArgoStoreConfiguration
{
    ...
    IDocumentStoreConfiguration<TDocument> Document<TDocument>() where TDocument : class, new();
}
...
public interface IDocumentStoreConfiguration<TDocument> where TDocument : class, new()
{
    /// <summary>
    /// Sets primary key
    /// </summary>
    ...
    IDocumentStoreConfiguration<TDocument> PrimaryKey<TProperty>(Expression<Func<TDocument, TProperty>> selector);
    ...
    /// <returns>Same instance of IEntityConfiguration</returns>
    IDocumentStoreConfiguration<TDocument> UniqueIndex<TProperty>(Expression<Func<TDocument, TProperty>> selector);
    ...
    /// <param name="selector">Lambda expression to select a single property as index or new anonymous object with multiple properties</param>
    /// <returns>Same instance of IEntityConfiguration</returns>
    IDocumentStoreConfiguration<TDocument> NonUniqueIndex<TProperty>(Expression<Func<TDocument, TProperty>> selector);
}